...
public class PembimbingAbsens extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pembimbing_absens);
        context = this;
        ...
        getSupportActionBar().setTitle("Daftar Absensi");
    ...
    private void showData() {
        ...
        dialog.show();
        apiInterface.getAbsen(prefManager.getKd_rayon())
                .enqueue(new Callback<getAbsen>() {
                    ...
                    public void onFailure(Call<getAbsen> call, Throwable t) {
                        Toast.makeText(context, "Belum ada absensi", Toast.LENGTH_SHORT).show();
                    }
                });
    }
